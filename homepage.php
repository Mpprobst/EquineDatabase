				...
				<fieldset>
					...
					<p>
						...
						<div class="show" id="ForelimbForm">
							...
							<div>
								<button onclick="openDistalRadius()">Distal Radius</button><br></br>
							...
							<div>
								<button onclick="openRadiocarpalBone()">Radiocarpal Bone</button>
							...
							<div>
								<button onclick="openMetacarpal3()">Metacarpal 3</button>
							...
							<div>
								<button onclick="openMedialSesamoid()">Medial Sesamoid</button>
